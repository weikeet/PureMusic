...
public class ImageUtil {
    ...
    public static void startAlbum(Activity activity) {
        ...
        activity.startActivityForResult(intent, ConstantUtil.REQUEST_ALBUM);
    }
    ...
    public static void startCorp(Activity activity, Uri uri) {
        ...
        activity.startActivityForResult(intent, ConstantUtil.REQUEST_CORP);
    }
}
