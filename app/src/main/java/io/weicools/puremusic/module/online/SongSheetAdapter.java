...
/**
 * Create by weicools on 2018/3/3.
 */
...
public class SongSheetAdapter extends BaseAdapter {
    ...
    private List<SongSheetInfo> mData;

    public SongSheetAdapter(List<SongSheetInfo> data) {
        mData = data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SongSheetInfo sheetInfo = mData.get(position);
        int itemViewType = getItemViewType(position);
        switch (itemViewType) {
            case TYPE_PROFILE:
                if (convertView == null) {
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.item_song_sheet_profile, parent, false);
            ...
            case TYPE_MUSIC_LIST:
                if (convertView == null) {
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.item_song_sheet, parent, false);
    ...
    private void getMusicListInfo(final SongSheetInfo sheetInfo, final ViewHolderMusicList holderMusicList) {
    ...
    private void parse(OnlineMusicList response, SongSheetInfo sheetInfo) {
    ...
    private void setData(SongSheetInfo sheetInfo, ViewHolderMusicList holderMusicList) {
